...
import org.wso2.siddhi.android.platform.IRequestController;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String startLine = "@app:name('foo')";
    ...
    public void sendApp(View view) { //change name
        ...
        try {
            ...
            String appName = comman.startSiddhiApp(app);
    ...
    public void stopApp(View view) {
        try {
            comman.stopSiddhiApp(runningAppName);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
